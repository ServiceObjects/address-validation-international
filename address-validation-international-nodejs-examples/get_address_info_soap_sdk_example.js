...
async function GetAddressInfoSoapGo(licenseKey, isLive) {
    console.log("\n------------------------------------------------------------");
    console.log("Address Validation International - GetAddressInfo - SOAP SDK");
    console.log("------------------------------------------------------------");
    ...
    try {
        ...
        if (response && response.AddressInfo) {
            ...
            if (response.AddressInfo.InformationComponents && response.AddressInfo.InformationComponents.InformationComponent && response.AddressInfo.InformationComponents.InformationComponent.length > 0) {
                response.AddressInfo.InformationComponents.InformationComponent.forEach((component) => {
